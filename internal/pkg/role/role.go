...
var (
	Leader   = newRole("LEADER")
	Follower = newRole("FOLLOWER")
)
...
// MarshalJSON provides support for JSON marshalling.
func (r Role) MarshalJSON() ([]byte, error) {
	return fmt.Appendf(nil, `"%s"`, r.value), nil
}

// UnmarshalJSON provides support for JSON unmarshalling.
